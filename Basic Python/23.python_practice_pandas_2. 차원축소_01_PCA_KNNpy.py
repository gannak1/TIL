# -*- coding: utf-8 -*-
"""
Created on Thu Jan  6 14:35:31 2022
...
ax.scatter(iris_x_pca3[iris_y==0,0],    # x 축 좌표
           ...
           iris_x_pca3[iris_y==0,2],
           c = 'b',
           cmap = mglearn.cm2,          # color map으로 그림
           s = 60,                      # 점의 크기(size)
           edgecolors = 'k'             # black
           ) # z 축 좌표
...
m_knn1.score(test_x1,test_y1) # 0.8947

m_pca2.explained_variance_ratio_ # 각 인공변수의 분산 설명력
# array([0.72962445, 0.22850762])
sum(m_pca2.explained_variance_ratio_) #0.958

m_knn2.fit(train_x2,train_y2)
m_knn2.score(test_x2,test_y2) # 0.9737 Seed값을 설정 안해서 할때마다 다름

m_pca3.explained_variance_ratio_ # 각 인공변수의 분산 설명력
# array([0.72962445, 0.22850762, 0.03668922])
sum(m_pca3.explained_variance_ratio_) #0.9948
