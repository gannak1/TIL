# -*- coding: utf-8 -*-
"""
Created on Wed Dec 29 14:13:32 2021
...
#    10%를 제외한 값의 최대값으로 수정하세요. 그리고 평균을 소수점 둘째자리로 반올림하여 출력
...
'''
     name   age  rank_average  rank_min  rank_max
0     KIM  24.0           1.5       1.0       2.0
1     LEE  32.0           3.0       3.0       3.0
2   SMITH  43.0           4.0       4.0       4.0
3   BROWN  24.0           1.5       1.0       2.0
4  MILLER   NaN           NaN       NaN       NaN
...
df1['symmetry_mean'].min()  #  '-' 어라, 문자값이 있네 
